...
public class Navigator {
    ...
    public static void launchDetail(BaseActivity fromActivity, View fromView, Thing thing, View backgroundView) {
...
//        注意这里的intent的传入的参数是要干嘛的！！！
        intent.putExtra("item_text2", thing.toString());
